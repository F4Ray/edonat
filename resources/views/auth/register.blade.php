...
<head>
    ...
    <title>Haxorsprogramming - Register</title>
...
<body>
                        ...
                        <div class="content content-full">
                            ...
                            <div class="px-30 py-10">
                                <div class="teksTengah">
                                    ...
                                    <div>
                                        <h5 style="text-align: center;">Member Registration</h5>
                                    </div>
                                </div>
                            ...
                            <div class="js-validation-signin px-30" id="divForm">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                ...
                                                <label for="login-fullname">Nama</label>
                                            </div>
                                            @error('name')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <select class="form-control" name="daftar_sebagai">
                                                    <option value="2">Donatur</option>
                                                    <option value="3">Penerima Donasi</option>
                                                </select>
                                                <label for="login-fullname">Daftar Sebagai</label>
                                            </div>
                                            @error('name')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
    ...
    // function SignUpAtc() {
    //     window.alert("Close for registration");
    // }
    </script>

    <script src="{{ asset('storage/ladun/login/assets/js/register.js') }}"></script>
